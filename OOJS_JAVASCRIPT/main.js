...
var obj1 = new developers('Bhupesh',4021,'FEEN');
console.log(obj1);
...
//   var abhi = {name: 'Devansh'};

//   sayHello.call(abhi); // Hello Devansh
//   var varun = {name: 'Varun'};

//   sayHello.call(varun); // Hello Devansh
